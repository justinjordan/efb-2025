...
class $06ea7b158ce0d77d$export$2e2bcd8739ae039 extends (0, $f94dd35d7e4c47f0$export$2e2bcd8739ae039) {
    constructor(game, canvas){
        ...
        this.ballLayer = new (0, $185b6a29245bc483$export$2e2bcd8739ae039)(canvas);
        this.trailLayer = new (0, $185b6a29245bc483$export$2e2bcd8739ae039)(canvas);
        this.backgroundLayer = new (0, $185b6a29245bc483$export$2e2bcd8739ae039)(canvas, {
            backgroundColor: "#000"
        });
    ...
    handleKeyup(e) {
        if (e.key === "p") this.game.pushState(new (0, $3c9a1211b363cd3e$export$2e2bcd8739ae039)(this.game, this.canvas));
    }
    onEnter() {
        document.addEventListener("keyup", this.handleKeyup);
    }
    ...
    render(canvas) {
        ...
        this.trailLayer = new (0, $185b6a29245bc483$export$2e2bcd8739ae039)(canvas, this.trailLayer).withLayer((canvas, ctx)=>{
...
class $b013a5dd6d18443e$export$2e2bcd8739ae039 {
    ...
    start() {
        ...
        // Add the first state
        const state = new (0, $06ea7b158ce0d77d$export$2e2bcd8739ae039)(this, this.canvas);
        state.onEnter();
